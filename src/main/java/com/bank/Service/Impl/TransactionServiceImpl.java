...
public class TransactionServiceImpl implements TransactionsService {
        ...
        .flatMap(client -> {
          ...
          if (transactionsRequest.getTypeTransaction().equals("deposito")) {
            ...
            balance = balance.add(amount);
              ...
              && balance.compareTo(amount.add(BigDecimal.valueOf(comission))) == 1) {
            balance = balance.subtract(amount.add(BigDecimal.valueOf(comission)));
              ...
              && clientProduct.getCreditLimit().compareTo(amount.add(consumption)) == 1) {
  ...
  public Boolean verifyRules(Client client, ClientProduct clientProduct,
    ...
    if (productRules != null) {
      int maxTransaction = typeTransaction.equals("deposito") ? productRules.getMaxDeposits() :
                          (typeTransaction.equals("retiro") ? productRules.getMaxWithdrawal() : -1);
